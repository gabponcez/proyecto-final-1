...
public class CrearCurso extends javax.swing.JFrame {
    ...
    public CrearCurso() {
        ...
        for(Profesor e : ProyectoFinal.profesores){
            jComboBox1.addItem(e.nombre);
        }
         jComboBox1.setSelectedIndex(-1);
         jTextField1.setText("C"+Cursos.contador);
